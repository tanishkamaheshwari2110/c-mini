...
void add_student()//To add student details
{
...
void find_rl()//To find the student details by roll number
{
    int x;
...
void find_fn()//To find the student details by their first name
{
    char a[50];
...
void find_c()//To find student details by course ID
{
    int id;
...
void tot_s()//To find the total number of students
{
    printf("The total number of student is %d\n",i);
    printf(" you can have a max of 50 students\n");
    if(i<50){
        printf("you can have more students\n", (50 - i));}
}
  
void del_s()//To delete  a student details by roll number
{
    int a;
    printf("Enter the Roll Number for which you want to delete\n");
    scanf("%d", &a);
    for (int j = 1; j <= i; j++) {
        if (a == st[j].roll) {
            for (int k = j; k < 49; k++)
...
void up_s()//To update a students data
{
